...
//	svm->setKernel(SVM::RBF);// 7 
// 	svm->setKernel(SVM::LINEAR);// 2
// 	svm->setKernel(SVM::POLY);// failed
// 	svm->setKernel(SVM::SIGMOID);// 9
// 	svm->setKernel(SVM::CHI2);// 7 
 	svm->setKernel(SVM::LINEAR);// 2
//	svm->setC(40.0);
...
/*	Mat src = imread("./led_data/72.jpg", 0);
	resize(src, src, Size(128, 128));
