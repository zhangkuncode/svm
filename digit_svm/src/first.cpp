...
int main(){
    ...
    float trainingData[7][2] = {{100, 100}, {100, 200}, {200, 100}, {300, 300}, 
		                        {300, 200}, {400, 200}, {500, 100} };
	
    int labels[7] = {1, 1, 1, -1, -1, -1, -1};
    // the type of image is stable
	Mat trainingDataMat(7, 2, CV_32F, trainingData);
    Mat labelsMat(7, 1, CV_32S, labels);
...
//    svm->setC(0.0000001);  
	...
	circle(image, Point(500,100), 5, Scalar(255, 255, 255), thickness, lineType);
